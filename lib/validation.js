...
export const CancelFormValidations = z.object({
  cancelReason: z.string().min(1, "Reason is required"), // Optional string
});
export const DoctorFormValidations = z.object({
  email: z.string().email("Invalid email address"),
  name: z
    .string()
    .min(2, "Name must be at least 2 characters")
